...
function PageSport() {
  const sections = [
    ...
    },
    {
      color: 'var(--pink)',
      label: 'Црвени крст',
      text: 'Лана Бера, Михаило Тешинић, Александра Ритан — 1. мјесто на општинском такмичењу и 2. регионално (ЦК). Дарио Личанин, Дариа Личанин, Уна Ковачић — 1. мјесто на општинском такмичењу и регионалном (Мисли мине) — пласман на Републичко. Менторица: Наташа Петковић.',
    },
    {
      color: 'var(--teal-deep)',
      label: 'Математика',
      text: 'Михаило Родић — 1. мјесто на општинском такмичењу. Лана Бера — 3. мјесто на општинском такмичењу. Ментори: Милена Мандић и Борис Крчковски.',
    },
    {
      color: 'var(--blue)',
      label: 'Српски језик',
      text: 'Уна Ковачић — 1. мјесто на општинском такмичењу, учешће на регионалном. Менторица: Зорица Гарача.',
    },
    {
      color: 'var(--purple)',
      label: 'Православна вјеронаука',
      text: 'Лана Бера — 1. мјесто на општинском такмичењу и учешће на епархијском такмичењу. Ментор: Жељко Јевђенић.',
    },
    {
      color: 'var(--navy)',
      label: 'Шах',
    ...
    },
    {
      ...
      label: 'Спорт · МОИ',
      text: 'Мушка екипа — 2. мјесто на општинском такмичењу (фудбал и одбојка). Женска одбојка — 3. мјесто на општинском такмичењу. Атлетика: Анамарија Цвијић (1.) и Николина Тубин (2.) на регионалном — пласман на Републичко. Менторица: Светлана Мијатовић.',
    },
    {
      color: 'var(--pink-hot)',
      label: 'Ликовни и литерарни',
      text: 'Уна Ковачић — 2. мјесто, Републички конкурс „Хуманост нас повезује". Уна Ковачић (3.) и Дарио Личанин (2.) — „Заједно против мина", општински ниво. Лука Тица — лауреат „Звончица са Уне" (школа домаћин 2026/27). Учешће на конкурсима: „Говори српски, пиши ћирилицом", „Моја рука бира како изгледа лектира", „Дан ријеке Уне". Ментори: Ана Орељ, Бојан Сантрач и Бојана Згоњанин.',
    },
  ];
