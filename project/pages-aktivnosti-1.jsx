...
Одличну сарадњу остварујемо са Општином Козарска Дубица, са којима смо у току године имали више заједничких активности, пројеката и успјешних реализација. Ове школске године општина је обезбиједила бесплатне уџбенике за све ученике од 5. до 9. разреда, као и бесплатне здраве оброке за ученике 1. разреда.
...
Ученицима четвртих разреда уручене су едукативне бојанке, припремљене поводом Дана општине. Бојанке су ученицима уручили начелник општине Игор Савковић, предсједник Српског просвјетног и културног друштва „Просвјета" Зоран Синкић, које је уједно и издавач овог издања, те просвјетни радници који су учествовали у изради ове бојанке.
...
function PagePriredbe2() {
  const body = `Школску годину започели смо учешћем на Традиционалној школској бициклијади, која је одржана 21.9. на релацији Козарска Дубица – Моштаница. Ученици су активно учествовали и у ширим друштвеним манифестацијама. Поводом Међународног дана особа са инвалидитетом, својим наступима у Дому културе послали су снажну поруку подршке, толеранције и заједништва.
...
Уређен тениски терен отвара нове могућности за физичко васпитање и слободне активности ученика, а истовремено је лијеп примјер како заједничким ангажовањем локалне заједнице, спортских организација и школе можемо створити боље услове за дјецу.`;
  ...
  const bodyPark1 = `Вођени жељом да дјеци обезбиједе љепше и функционалније окружење за боравак и учење, запослени школе, родитељи, бивши ученици, донатори и пријатељи школе заједничким снагама започели су уређење школског парка. Идеја је била да школско двориште постане едукативан и мултифункционалан простор у којем ће ученици учити, истраживати, дружити се и стварати успомене.`;

  const bodyPark2 = `До сада су уређене стазе, засађене украсне саднице, уређен кутак намијењен изложби практичних радова наставе техничког образовања, постављена библиотека на отвореном и изграђена љетна учионица која је већ постала омиљено мјесто окупљања ученика.

Вриједна донација материјала за изградњу љетне учионице стигла је захваљујући господину Горану Ковачевићу и фирми ГМБ инжињеринг. Све до сада наведене радове, успјели смо реализовати уз подршку Општине Козарска Дубица, господина Даријана Бабића, породице Бабић и породице Тубић из Кнежице, којима се овим путем захваљујемо.`;
      ...
      <div style={{ padding: '90px 50px 60px' }}>
        ...
        <div style={{ marginTop: 22, display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 22, alignItems: 'start' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <ArticleBody text={bodyPark1} style={{ fontSize: 12, lineHeight: 1.6 }} />
          </div>
