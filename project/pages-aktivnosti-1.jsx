...
До сада су уређене стазе, засађене украсне саднице, уређен кутак намијењен изложби практичних радова наставе техничког образовања, постављена библиотека на отвореном и изграђена љетна учионица која је већ постала омиљено мјесто окупљања ученика.`;

  const bodyPark2 = `Вриједна донација материјала за изградњу љетне учионице стигла је захваљујући господину Горану Ковачевићу и фирми ГМБ инжињеринг. Све до сада наведене радове, успјели смо реализовати уз подршку Општине Козарска Дубица, господина Даријана Бабића, породице Бабић и породице Тубић из Кнежице, којима се овим путем захваљујемо.`;
