...
function PageAktivnostiOpener() {
  const items = [
    ...
    { title: 'Спортска такмичења',              page: '16' },
  ...
  return (
    <div className="mag-page" style={{ '--accent': 'var(--orange)' }}>
      ...
      <div style={{
        ...
        П О Г Л А В Љ Е &nbsp;&nbsp;0<span style={{ color: 'var(--ink)' }}>4</span>
      </div>

      {/* hero typography */}
      <div style={{ position: 'absolute', top: 200, left: 70, right: 70 }}>
        <div className="headline" style={{ fontSize: 168, lineHeight: 0.86, color: 'var(--navy)' }}>
          Активно<span style={{ color: 'var(--orange)' }}>—</span><br/>
          сти.
        </div>
        <div style={{
          marginTop: 24,
          ...
          {/* hand underline */}
          <svg width="380" height="10" viewBox="0 0 380 10"
            style={{ position: 'absolute', bottom: -10, left: 0 }}>
            <path d="M 4 5 Q 80 1, 160 4 T 320 4 T 376 5"
      ...
      <div style={{ padding: '90px 50px 60px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 26, alignItems: 'start' }}>
          <div>
            ...
            <Photo label="ДЈЕЧИЈА НЕДЈЕЉА" height={170} style={{ marginTop: 16 }}
              caption="Посјета Народној библиотеци, октобар 2025." />
        ...
        <Photo label="ДОЊА ГРАДИНА" height={110} style={{ position: 'absolute', bottom: 78, left: 50, right: 50 }}
          caption="Дан сјећања на жртве концентрационог логора Јасеновац." />
      </div>
    </PageShell>
  );
}
...
Object.assign(window, {
  PageAktivnostiOpener, PageSaradnja1, PageSaradnja2,
