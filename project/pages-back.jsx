...
У организацији Републичког педагошког завода реализована је 17. школа директора под називом „Школа у времену промјена — одговорност савременог директора", у којој је учествовала и директор наше школе, Бојана Крњајић.
      ...
      <div style={{ padding: '90px 50px 60px' }}>
        ...
        <div style={{ marginTop: 26, display: 'grid', gridTemplateColumns: '1.3fr 1fr', gap: 26, alignItems: 'start' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            ...
            <Photo src="assets/zezelj.jpg" height={210} style={{ objectPosition: 'center 30%' }}
          ...
          <div>
            <div style={{ marginTop: 0 }}>
              ...
              <div style={{ marginTop: 8, fontFamily: 'var(--serif)', fontSize: 12.5,
                ...
                Удружење младих „Фокус" · Мото клуб „Чопор" ·
                Спомен-подручје Доња Градина · Борачка организација ·
                Дом здравља Козарска Дубица · СПЦО Кнежица · ООЦК Козарска Дубица ·
